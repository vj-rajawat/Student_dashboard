...
<body>
<form action="{{URL::to('/edit/'.$data->rollno)}}" class="col-md-4 mx-auto mt-4 border border-primary p-4" method="post" enctype="multipart/form-data">
  @csrf
<div>
  ...
  <div class="col-md-12">
    ...
    <input type="text"  name="myname" value="{{$data->name}}" class="form-control mb-4" id="inputEmail4">
  </div>
  <div class="col-md-12">
    <label for="inputPassword4" class="form-label">Gender</label>
    <input type="text"  name="mygend" value="{{$data->gender}}" class="form-control mb-4" id="inputPassword4">
  </div>
  <div class="col-12">
    <label for="inputAddress" class="form-label">class</label>
    <input type="text"  name="myclass" value="{{$data->class}}" class="form-control mb-4" id="inputAddress" placeholder="">
  </div>
  <div class="col-12">
  ...
  <div class="col-md-12">
    ...
    <input type="text"  name="myprnt" value="{{$data->father}}" class="form-control mb-4" id="inputCity">
  </div>
  <div class="col-md-12">
